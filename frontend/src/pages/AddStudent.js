                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <form onSubmit={saveStudent} >
                                    ...
                                    <div className="form-group mb-3">
                                        <label>Student Phone</label>
                                        <input type="file" name="image" onChange={handleInput} value={studentInput.image}  className="form-control" />
                                        <span className="text-danger">{studentInput.error_list.image}</span>
                                    </div>
